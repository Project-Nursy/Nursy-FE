...
//   return (
//     <div className="bg-gray-100 h-screen p-6 shadow-lg">
//       <div className="mb-8">
//         <h2 className="text-2xl font-bold text-sky-600">${ward.wardName}</h2>
...
//         <li>
//           <button
//             onClick={() => navigate('/ward/generate')}
//             className="w-full text-left px-4 py-2 bg-white rounded-lg shadow-md hover:bg-sky-100 transition-colors text-gray-700 font-medium"
//           >
//             근무표 생성
//           </button>
